...
import type { TransactionEIP1559, TransactionEIP2930, TransactionEIP4844, TransactionLegacy, TransactionReceipt, TransactionRequestEIP1559, TransactionRequestEIP2930, TransactionRequestLegacy } from './transaction.js';
...
export type RpcTransaction<TPending extends boolean = boolean> = UnionOmit<UnionPartialBy<TransactionLegacy<Quantity, Index, TPending, '0x0'> | TransactionEIP2930<Quantity, Index, TPending, '0x1'> | TransactionEIP1559<Quantity, Index, TPending, '0x2'> | TransactionEIP4844<Quantity, Index, TPending, '0x3'>, 'yParity'>, 'typeHex'>;
