...
exports.getFrameAccountAddress = void 0;
 ...
 */
async function getFrameAccountAddress(message, { NEYNAR_API_KEY = 'NEYNAR_ONCHAIN_KIT' }) {
    ...
    const bulkUserLookupResponse = await (0, neynarUserFunctions_1.neynarBulkUserLookup)([farcasterID], NEYNAR_API_KEY);
    if (bulkUserLookupResponse?.users) {
        const userVerifications = bulkUserLookupResponse?.users[0];
...
exports.getFrameAccountAddress = getFrameAccountAddress;
//# sourceMappingURL=getFrameAccountAddress.js.map